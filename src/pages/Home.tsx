...
import { tokenStore } from "@/api/http"; // ✅ adjust this import to match your file path
...
const Button = ({
  ...
  const variants: Record<ButtonVariant, string> = {
    ...
    secondary:
      "bg-white text-gray-900 hover:bg-gray-50 border-2 border-gray-200 shadow-md",
...
const Home = () => {
  ...
  const handleStartPractice = () => {
    const token = tokenStore.get(); // ✅ check if user is authenticated
    if (token) {
      navigate("/dashboard");
    } else {
      navigate("/login");
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-12">
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Select from behavioral, technical, or industry-specific
                  questions based on your interview needs.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Answer questions naturally while our AI analyzes your response
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Receive specific suggestions on how to improve clarity,
                  structure, and impact of your answers.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 md:py-28 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Tools designed to help you practice effectively and improve with
                each session
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-4 p-6 bg-white rounded-xl border border-gray-100 hover:border-indigo-200 hover:shadow-md transition-all">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Practice speaking your answers aloud or type them out -
              ...
              <div className="flex items-start space-x-4 p-6 bg-white rounded-xl border border-gray-100 hover:border-indigo-200 hover:shadow-md transition-all">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Understand your strengths and get specific tips on areas
